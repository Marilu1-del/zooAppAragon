...
<body>
    ...
    <div class="container">
        ...
        <button class="btn" onclick="window.location.href='agregarPersonal.php'">
            ...
            <table>
                ...
                <?php while($row = mysqli_fetch_assoc($query)): ?> 
                    ...
                    <tr>
                        ...
                        <td> <?= $row['Telefono'] ?> </td>
                        <td class="actions">
                        <!--<a href="consultar.php"><i class="fas fa-eye view"></i></a>-->
                        <a href="update.php?PersonalID=<?= $row['PersonalID'] ?>"><i class="fas fa-edit edit"></i></a>
                        <a href="deleteP.php" onclick="confirmarEliminacion(event, <?= $row['PersonalID'] ?>)">
                        <i class="fas fa-trash delete"></i></a>
                        <a href="agregarPersonal.php"><i class="fas fa-user-plus add"></i></a>
                        </td>
                    </tr>
